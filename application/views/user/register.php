...
<head>
    ...
    <title  data-i18n="title">注册|创建账户</title>
...
<div class="wrap">
    <div class="register_main">
        ...
        <div class="register_progress">
            <div class="regpro_box clearfix">
                <div class="regpro_list fl">
                    <b class="regpro_i fl"></b>
                    <div class="regpro_con active fl">
                        <i>1</i>
                        <span  data-i18n="create_account"></span>
                    </div>
                    <b class="regpro_i fl"></b>
                </div>
                <div class="regpro_list fl">
                    <b class="regpro_i fl"></b>
                    <div class="regpro_con  fl js-verify-email">
                        <i>2</i>
                        <span  data-i18n="verify_email"></span>
                    </div>
                    <b class="regpro_i fl"></b>
                </div>
                <div class="regpro_list fl">
                    <b class="regpro_i fl"></b>
                    <div class="regpro_con fl">
                        <i>3</i>
                        <span  data-i18n="start_trade"></span>
                    </div>
                    <b class="regpro_i fl"></b>
                </div>
            </div>
...
<script data-main="http://st.test.com/xnb_home/js/module/user/register.js" src="http://st.test.com/xnb_home/js/lib/requirejs.js"></script>

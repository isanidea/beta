...
<head>
    ...
    <title data-i18n="news_detail_title"></title>
...
<script data-main="http://st.test.com/xnb_home/js/module/notice/detail"
        src="http://st.test.com/xnb_home/js/lib/requirejs.js"></script>

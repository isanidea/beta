...
<head>
    ...
    <title data-i18n="news_index_title"></title>
...
<div class="wrap">
    ...
    <div class="news_top">
        <div class="newstop_wen">
            <h2 data-i18n="news_center"></h2>
            <p data-i18n="news_text1"></p>
            <p data-i18n="news_text2"></p>
        </div>
    </div>
    <div class="news_content">
        <div class="newsDiv notice">
            <div class="news_list allnotice clearfix">
                <!--列表-->

            </div>
            <div class="posts_line"></div>
...
<script data-main="http://st.test.com/xnb_home/js/module/notice/index" src="http://st.test.com/xnb_home/js/lib/requirejs.js"></script>

...
class Test extends MY_Controller {
    ...
    public function test()
    {
        ...
        $list = $this->finance_service->Model_t_finance_info->get_finance_list_by_uin($this->conn,$uin,1,10,$aQuery,$sort=NULL);
        render_json_list(0,'',$list['total'],$list['rows']);
    }
}
...
//    private $user = 'FBI@2017.user'; // rpcuser
//    private $password = 'FBI2017.wallet'; // rpcpassword
...
//        $this->load->helper('jsonrpcclient');
//
...
////        var_dump($this->bitcoin->getinfo());
////        return $this->bitcoin->getinfo();
//        render_json(0,'',$this->bitcoin->getbalance());
//    }
//
//    /**

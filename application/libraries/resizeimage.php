...
class resizeimage
{
    ...
    function resizeimage($img, $wid, $hei,$cut,$dst_img)  //源图像 | 宽 | 高 | 是否裁切 | 目标地址
    {
        $this->srcimg = $img;
...
//使用方法
// $resizeimage = new resizeimage("test.jpg", "224", "126", "0");